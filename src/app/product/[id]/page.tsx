          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
              <div className="flex items-center gap-1 text-yellow-500">
                  ...
                  {isClient && reviewCount > 0 && <span className="text-muted-foreground ml-1">({reviewCount} reseñas)</span>}
              </div>
              {isClient && soldCount > 0 && <span className='text-green-600 font-semibold'>{soldCount} vendidos</span>}
            </div>
          </div>
